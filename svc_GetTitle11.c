...
#include "svc_GetTitle11.h"

static char sasf_service_name[] = "GetTitle11";
...
int
GetTitle11 (SASD *sasd_csv, SASD * _SASF_SASD_IN, SASD * _SASF_SASD_OUT)
{
   struct GetTitle11Request *req;
   struct GetTitle11Response *res;
